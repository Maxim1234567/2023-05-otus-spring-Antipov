...
public class DatabaseChangelog {
    private final List<Passport> passports = List.of(
            Passport.builder()
                    ...
                    .number("111111")
                    .issued("there")
                    .dateOfIssue("00.00.0000")
                    .codeDivision("000-000")
                    .build(),
            Passport.builder()
                    .id("2")
                    .series("0001")
            ...
            Passport.builder()
                    ...
                    .number("111000")
                    .issued("here")
                    .dateOfIssue("00.00.3000")
                    .codeDivision("001-000")
                    .build(),
            Passport.builder()
                    .id("5")
                    .series("0100")
